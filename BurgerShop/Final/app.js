/// pay functionality
const form = document.getElementById("billingAddress");
const payBtn = document.getElementById("pay");
const payDiv = document.querySelector(".pay-container");
const message = document.querySelector(".deliv");
...
const __KEY = "AIzaSyC7vrKelXxcX1R3ePXoBqkG_rmCzg__X18";
